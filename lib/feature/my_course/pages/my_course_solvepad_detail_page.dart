...
import 'package:solve_student/feature/my_course/controller/my_course_solvepad_detail_controller.dart';
...
class MyCourseSolveDetailPage extends StatefulWidget {
  ...
  String courseId;
  @override
  State<MyCourseSolveDetailPage> createState() => _MyCourseDetailPageState();
}

class _MyCourseDetailPageState extends State<MyCourseSolveDetailPage> {
  MyCourseSolvepadDetailController? controller;
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      value: controller,
      child: Consumer<MyCourseSolvepadDetailController>(
                                      ...
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) => LearningPage(
                                            lesson: con.courseDetail!.lessons![index],
                                            course: con.courseDetail!,
                                            tutorId: con.tutor!.id!,
                                          ),
                                        ),
                                      );
                                    },
  ...
  Widget subjectWidget(
      MyCourseSolvepadDetailController con, CourseMarketModel only) {
  ...
  Widget tutorWidget(MyCourseSolvepadDetailController con) {
    return Container(
      child: Text(
        con.tutor?.name ?? "",
        style: const TextStyle(
  ...
  Widget starSelectWidget(
      int selectedStar, MyCourseSolvepadDetailController con) {
    return GestureDetector(
      onTap: () {
