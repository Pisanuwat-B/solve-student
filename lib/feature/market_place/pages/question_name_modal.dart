  ...
  Widget _buildQuestionForm() {
    return Column(
      ...
      children: [
        ...
        const Text("ตั้งชื่อคำถามนี้ เพื่อให้สะดวกต่อผู้สอน: "),
        const SizedBox(height: 10),
        SizedBox(
          width: 200,
          child: TextFormField(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: CustomColors.redB71C1C,
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('ยกเลิก', style: CustomStyles.bold14White),
